package cn.edu.ccdx.demo.domain;
...
import cn.edu.ccdx.util.db.DAOTemplate;
import cn.edu.ccdx.util.db.LongGenerator;

public class OperationDAO extends DAOTemplate<Operation> {
	...
	@Override
	protected void setIdBeforeInsert(JdbcTemplate jt, Operation opt) {
		// TODO Auto-generated method stub
	 ...
	 * @throws SQLException
	 */
	public List<?> search(JdbcTemplate jt, String where, Object[] params) {
